            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #21b954;" style="border-radius:0%;">Transact</button></a></td> 
                    </tr>
                <?php
                $cnt=$cnt+1;
                    }
