...
<body style="background-color : #ccade6;">
<?php
    include 'config.php';
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="./usericon.png" style="border: none; border-radius: 10%;">
        </div>
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group">
              <input class="app-form-control" placeholder="INITIAL AMOUNT" type="number" name="balance" required>
            </div>
            <br>
